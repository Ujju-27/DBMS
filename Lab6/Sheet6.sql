...
v. Enter a record with your detail in the table with your actual DOB.
  SQL> insert into employee values(7, 'Ujjawal', 'Haldwani', '27/Jun/2003', sysdate, 60000);
...
x. Display list of all employees who were born after your DOB.
  SQL> select * from employee where dob>'27/JUN/2003';
...
z. Again enter your detail record and this time store your Birth time also.
  SQL> insert into employee values(7, 'Sandarbh', 'Rishikesh', to_date(to_char('27/Jun/2003 02:10:30'), 'DD MON YYYY HH:MI:SS'), sysdate, 60000);
...
Ujjawal                   27-JUN-03 02:10:30 21.1827957
